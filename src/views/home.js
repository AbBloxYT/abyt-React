  ...
  return (
    <div className="home-container">
      ...
      <div className="home-features">
        <h2 className="headline2 home-text16">Games</h2>
      ...
      <div className="home-testimonials">
        <div className="home-container08">
          <div className="home-container09">
            ...
            />
            <h1 className="home-text18 headline2">
      ...
      <div className="home-c-t-a">
        <div className="home-container21">
          <div className="home-container22">
            <h2 className="headline2 home-text33">
      ...
      <div className="home-footer">
        <footer className="home-container24">
          ...
          <div className="home-container25">
            <span className="home-text39">About</span>
            <span className="home-text40">Features</span>
            <span className="home-text41">Pricing</span>
            <span className="home-text42">Careers</span>
            <span className="home-text43">Help</span>
            <span className="home-text44">Privacy Policy</span>
          </div>
          <div className="home-divider2"></div>
          <div className="home-container26">
            <span className="home-text45 body2">
